...
export class NavbarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  ChangeLanguage(language: string) {
    ...
    if (language === 'en') {
      ...
      this.selectedLanguageText = "Romana";
      this.selectedLanguageFlag = "./assets/img/flags/ro.png";
    }
    else if (language === 'hu') {
      this.selectedLanguageText = "Magyar";
      this.selectedLanguageFlag = "./assets/img/flags/hu.png";
    }
